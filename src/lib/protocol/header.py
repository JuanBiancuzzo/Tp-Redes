...
class Header:
    def __init__(self, src_port, dst_port, seq_num, ack_num, data_len, syn, ack, fin, is_last):
    ...
    def serialize(self):
        ...
        flags = (self.syn << 3) | (self.ack << 2) | (self.fin << 1) | self.is_last
    ...
    def deserialize(cls, data):
        ...
        is_last = bool(flags & 0b0001)
        return cls(src_port, dst_port, seq_num, ack_num, data_len, syn, ack, fin, is_last)